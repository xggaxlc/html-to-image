...
function resourceToDataURL(resourceUrl, contentType, options) {
    return __awaiter(this, void 0, void 0, function () {
        var resourceUrlToFetch, cacheKey, dataURL, content, error_1, msg;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    resourceUrlToFetch = resourceUrl;
                    ...
                    cacheKey = getCacheKey(resourceUrlToFetch, contentType, options.includeQueryParams);
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, fetchAsDataURL(resourceUrlToFetch, options.fetchRequestInit, function (_a) {
                ...
                case 3:
                    ...
                    msg = "Failed to fetch resource: ".concat(resourceUrlToFetch);
                    if (error_1) {
